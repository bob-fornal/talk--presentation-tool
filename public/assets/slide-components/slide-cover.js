      ...
      <div class="slide--wrapper">
        ...
        <div class="slide--title-wrapper">
          <div class="slide--title">
            <div class="slide--title-inner">${at(this._content.title)}</div>
          </div>
        </div>
